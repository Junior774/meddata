...
TextField teste;
  ...
  _cadastrarUsuario(Medico medico) async {
    FirebaseAuth auth = FirebaseAuth.instance;
    auth
        .createUserWithEmailAndPassword(
            email: medico.email, password: medico.senha)
        .then((firebaseUser) {
    //  setState(() {
      ...
      //});
       ...
       .setData(medico.toMap());
       
      Navigator.of(context).pushNamedAndRemoveUntil('/cadastro_medico2', (route) => false);
